...
def buildEKE1(sender: str, c1):
    eke1 = { "type":"EKE_1", "from":sender,"c1":base64.b64encode(c1).decode('utf-8')}
    return json.dumps(eke1)

def buildEKE2(sender: str, c2: str, c3: str):
    eke2 = { "type":"EKE_2", "from":sender,"c2":c2,"c3":c3}
    return json.dumps(eke2)

def buildEKE3(sender: str, c4: str):
    eke3 = { "type":"EKE_3", "from":sender,"c4":c4}
    return json.dumps(eke3)

def buildEKE4(sender: str, c5: str):
